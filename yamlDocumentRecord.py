...
#   team: TEChallenge Team id -- techallenge for all
...
# .../NIST-SGCPS/TEChallenge/<filename> and the checksums from the file,
# of course.
#
...
s3Prefix = "https://s3.amazonaws.com/nist-sgcps/TEChallenge/"
bucket = "nist-sgcps/TEChallenge/"
